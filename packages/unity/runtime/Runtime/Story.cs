...
namespace Aige
{
    ...
    /// if (Story.HasFlag("saw_photo_1") &amp;&amp; Story.Has("knife")) Story.SetObjective("Find Sam's room", "Door_Stairs", pointerDelay: 30);
    ...
    public sealed class Story : MonoBehaviour
    {
        ...
        /// <example><code>Story.SetObjective("Find Sam's room", "Door_Stairs", pointerDelay: 45);</code></example>
